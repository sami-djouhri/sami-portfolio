...
export const CV_EXPERIENCE: CvExperience[] = [
  {
    ...
    bullets: [
      ...
      'Bedarfsgesteuerter Betrieb schwerer Rollen auf knappem Arbeitsspeicher: ein selbst geschriebener Regler entscheidet anhand echter Auslastung und gemessenem freiem Platz, wer starten darf, fährt weichende Rollen mit Zustandssicherung herunter und schaltet Leerlauf nach gesetzter Frist ab; belegte Rollen werden nie erzwungen geräumt.',
...
const CV_EXPERIENCE_EN: CvExperience[] = [
  {
    ...
    bullets: [
      ...
      'On-demand operation of heavy roles on constrained memory: a self-written controller decides from real occupancy and measured headroom who may start, shuts departing roles down with their state saved, and switches idle roles off after a set timeout; occupied roles are never evicted by force.',
...
const CV_HIGHLIGHTS_EN: string[] = [
  `A self-built homelab running ${DIENSTE_PROSA.en.klein} services around the clock across several hosts, measured against a version-controlled service map.`,
