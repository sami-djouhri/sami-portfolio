...
const SITE_META: Record<Locale, { title: string; description: string }> = {
  de: {
    title: 'Sami Djouhri, Infrastruktur & selbst gebaute Systeme',
    description:
      'Infrastruktur, Systeme und Automatisierung aus dem Raum Düsseldorf. Eigene Productivity-Suiten und ein Homelab-Cluster, selbst gebaut und selbst betrieben.',
  },
  en: {
    title: 'Sami Djouhri, self-owned systems & infrastructure',
    description:
      'Infrastructure, systems and automation from the Düsseldorf area, Germany. Productivity suites, a homelab cluster, AI bots, self-built, hardened and self-run.',
  },
};
