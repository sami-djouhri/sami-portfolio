...
export async function GET(req: Request) {
  // Vorübergehend abgeschaltet, siehe lib/cv.ts CV_OEFFENTLICH. Die Route muss
  // eigenständig prüfen: eine ausgeblendete Schaltfläche verbirgt die Datei
  // nicht, und diese URL steht in Lesezeichen, im Feed-Umfeld und in fremden
  // Verweisen. Wer sie direkt aufruft, bekommt 404 wie bei /cv selbst.
  if (!CV_OEFFENTLICH) {
