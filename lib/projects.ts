...
export const PROJECTS: Project[] = [
  ...
  },
  {
    id: 'homelab',
    title: 'Homelab',
    tagline: `${DIENSTE_PROSA.de.gross} eigene Dienste auf mehreren Hosts, seit 2024 im Dauerbetrieb.`,
  ...
  },
  {
    ...
    year: 'seit 2026',
    highlight: 'Lokale GPU-Inferenz im Heimnetz, unabhängig von der Cloud. Die Edge-Hardware ist derzeit nicht am Netz, die Pipeline wartet auf sie.',
...
> = {
  ...
  'ai-vision': {
    ...
    highlight: 'Local GPU inference inside the home network, independent of any cloud. The edge hardware is currently off the network, and the pipeline is waiting for it.',
...
export const ABOUT = {
  ...
  bio: 'Mir ist wichtig, dass ich verstehe, was bei mir läuft. Ein Fremdprodukt kann morgen seinen Preis verdreifachen oder die API abschalten, und dann steht man da. Also baue ich die Dinge selbst, auch wenn sie dadurch kleiner ausfallen, und dokumentiere sie so, dass auch jemand anderes sie übernehmen könnte.',
  contact: {
...
const ABOUT_EN = {
  ...
  bio: 'It matters to me that I understand what runs on my own machines. A third-party product can triple its price or switch off its API tomorrow, and then you are stuck. So I build things myself, even when that means they come out smaller, and document them so that somebody else could take them over.',
};
