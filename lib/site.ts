 ...
 * VORÜBERGEHEND und ausdrücklich als Abschalten, nicht als Löschen. Grund ist
 * keine technische Panne, sondern die Zurechnung: mehrere Bullets in lib/cv.ts
 * formulieren Autorschaft („ein selbst geschriebener Regler", „self-built lean
 * auth service"). Diese Formulierung soll überarbeitet werden, bevor der
 * Lebenslauf wieder draußen steht. Ein Bewerbungsdokument ist die falscheste
 * Stelle für eine Zuschreibung, die man im Gespräch relativieren müsste.
 *
