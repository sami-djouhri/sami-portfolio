...
export function ArchitectureDiagram({ architecture }: { architecture: Architecture }) {
  ...
  return (
    ...
    // zweimal vorgelesen, einmal als Label und einmal als Bildunterschrift.
    <figure className="m-0">
      <div className="overflow-hidden rounded-lg border border-border bg-surface/30" aria-hidden="true">
                ...
                <div key={tier.label} className="relative bg-bg p-5">
                  ...
                  {!last && !hasOverlay ? (
                    <>
                      ...
                      <span
                        aria-hidden
                        className="absolute right-[-0.65rem] top-1/2 z-10 hidden -translate-y-1/2 font-mono text-base text-term md:block"
                      >
                        →
                      </span>
                      <span
                        aria-hidden
                        className="absolute bottom-[-0.7rem] left-1/2 z-10 block -translate-x-1/2 font-mono text-base text-term md:hidden"
                      >
                        ↓
                      </span>
                    </>
          ...
          {hasOverlay ? (
            ...
            >
              <defs>
                ...
                >
                  <path d="M 0 0.5 L 7.5 4 L 0 7.5" fill="none" stroke="#5ac56f" strokeWidth="1.4" />
                </marker>
