...
export const PROOF_DEFAULTS = {
  // Bewusst die NIEDRIGERE von zwei unabhängigen Messungen (Stand 2026-08-10):
  // die Service-Map erwartet 163 laufende Dienste, live gezählt laufen 169
  // Container über alle Hosts. Im Zweifel untertreiben, nie hochrechnen.
  services: 163,
  drift: 0,
