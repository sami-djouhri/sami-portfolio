...
export const PROJECT_DETAILS: Record<string, ProjectDetail> = {
  ...
  'ai-vision': {
    ...
    limits: [
      'Die Edge-Hardware ist derzeit nicht am Netz, die Pipeline wartet auf sie. Die Reaktivierung über einen anderen Datenträger ist vorbereitet, aber nicht erledigt. Der Rest des Stacks merkt davon nichts, weil die Bild-Aufträge in der Warteschlange stehen bleiben statt zu scheitern, und genau dafür ist sie da.',
