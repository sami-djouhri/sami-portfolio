...
const HOME_DESC: Record<Locale, { description: string; og: string }> = {
  de: {
    ...
    og: `${DIENSTE_PROSA.de.gross} selbst betriebene Dienste, gehärtet und dokumentiert. Infrastruktur, Betrieb und Automation, selbst gebaut.`,
  },
  en: {
    description:
    ...
    og: `${DIENSTE_PROSA.en.gross} self-run services, visible hardening and documented care. Infrastructure, operations and automation, self-built.`,
  },
};
    ...
    <section className="pb-16 pt-4 sm:pt-8">
      ...
      <div className="mt-3 border-l border-border/60 pl-4 sm:pl-5">
        ...
        >
          ...
          <span className="whitespace-nowrap text-muted-dim">
            {t(locale, 'hero.boot.selfRun')}
          </span>
        </p>
      </div>
