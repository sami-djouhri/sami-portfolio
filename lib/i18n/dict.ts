...
const de: Dict = {
  ...
  'hero.row.focusValue': 'Eigen-Systeme',
  'home.featured.title': 'Drei Projekte, drei Anker',
  'home.featured.lead':
    'Das sind eigene Systeme, die ich gebaut habe und selbst betreibe, über Jahre, im echten Einsatz, mit Verantwortung für Betrieb und Sicherheit. Drei davon als Anker, der Rest in der vollen Liste.',
  ...
  'projects.lead':
    'Jedes Projekt läuft oder wächst gerade, keines ist eine Tutorial-Übung. Featured oben, darunter Projekte im Betrieb und das Lab in Arbeit, filterbar nach Domäne und Stack.',
...
const en: Dict = {
  ...
  'hero.row.modeValue': 'Remote · LAN-first',
  'hero.row.focusValue': 'Self-owned systems',
