  ...
  return {
    ...
    description:
      locale === 'en'
        ...
        : 'Werkzeugkasten mit Begründung, tägliches Setup und offengelegte Aggregat-Zahlen über das Portfolio. Ein Ort für Stack, Uses und Stats.',
    ...
    openGraph: {
      description:
        locale === 'en'
          ...
          : 'Der Werkzeugkasten mit Begründung: Stack, tägliches Setup und offengelegte Aggregat-Zahlen über das Portfolio.',
    },
  };
}
...
const RATIONALES_DE: Rationale[] = [
  {
    label: 'Infra & Ops',
    body: 'Docker Compose ist absichtlich kein Kubernetes, ein Homelab braucht keinen Cluster-Scheduler, sondern lesbare Compose-Files mit Härtung pro Service. cloudflared statt offener Ports, WireGuard für persönliche Remote-Sessions, Authelia als zentraler OIDC-Provider.',
...
const RATIONALES_EN: Rationale[] = [
  {
    label: 'Infra & Ops',
    body: 'Docker Compose is deliberately not Kubernetes: a homelab does not need a cluster scheduler, it needs readable compose files with per-service hardening. cloudflared instead of open ports, WireGuard for personal remote sessions, Authelia as the central OIDC provider.',
...
const USES_DE: UsesEntry[] = [
  ...
  },
  {
    ...
    slug: 'frontend',
    items: [
      { name: 'Next.js 14 App Router', note: 'wenn React passt' },
...
const USES_EN: UsesEntry[] = [
  ...
  },
  {
    ...
    slug: 'frontend',
    items: [
      { name: 'Next.js 14 App Router', note: 'when React fits' },
  ...
  return (
    <div className="relative">
      ...
      <main id="main" className="mx-auto max-w-5xl px-6 pb-32 pt-12 sm:px-8 sm:pt-16">
        ...
        {/* ---------------- #philosophie ---------------- */}
        <section id="philosophie" className="section-anchor pt-20">
            ...
            <Reveal as="ol" stagger className="mt-10 space-y-10">
              {RATIONALES.map((r, i) => {
                ...
                return (
                  <li
                    key={r.label}
                    className="grid gap-8 border-b border-border/60 pb-10 last:border-0 sm:grid-cols-12"
                  >
        ...
        {/* ---------------- #setup ---------------- */}
        <section id="setup" className="section-anchor pt-20">
          ...
          <div className="pt-10">
            <div className="flex items-end justify-between gap-6 border-b border-border pb-4">
              ...
              <span className="hidden font-mono text-sm text-accent/60 sm:block">
        ...
        {/* ---------------- #zahlen ---------------- */}
        <section id="zahlen" className="section-anchor pt-20">
              ...
              {frequency.map(([name, count]) => {
                ...
                return (
                  <li key={name} className={`font-display leading-tight ${size}`}>
                    {name}
                    <sup className="ml-1 font-mono text-[0.6rem] text-muted-dim">{count}</sup>
                  </li>
                );
              })}
            </ul>
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-surface/40">
      <WindowBar
        ...
        right={
          <span className="font-mono text-[0.65rem] uppercase tracking-widest text-accent/60">
            {index}
          </span>
        }
      />
