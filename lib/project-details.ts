...
export const PROJECT_DETAILS: Record<string, ProjectDetail> = {
  ...
  homelab: {
      ...
      tiers: [
        ...
        },
        {
          ...
          nodes: [
            ...
            { id: 'backup', label: 'Off-Site-Backup', note: 'verschlüsselt, DR-Runbook', kind: 'data' },
    ...
    decisions: [
      {
        ...
        body: 'Linkerd/Istio sind für Heimsetups Overkill. Reverse-Proxy, Tunnel, VPN und segmentierte Compose-Netze leisten das Nötige.',
      },
      {
    ...
    // ★ Hier standen bis 2026-09-13 zwei Zahlen, die sich gegenseitig widerlegten:
    // „165 über die Flotte" direkt über einem Ergebnis-Absatz, der korrekt die
    // Größenordnung nannte, und „Drift: 0 gegen die Quelle" trotz des
    // Owner-Entscheids vom 2026-08-31, den gemessenen Drift NICHT zu
    // veröffentlichen. Die exakte Zahl trägt allein das gemessene Panel mit
    // Zeitstempel; hier steht die Größenordnung aus der einen Quelle.
    metrics: [
      { label: 'Dienste live', value: `${DIENSTE_PROSA.de.gross} über die Flotte` },
      { label: 'Wiederherstellung', value: 'quartalsweise geprobt, byte-genau verglichen' },
  ...
  lernen: {
    ...
    approach: [
      ...
      'Geteilte Web-Bausteine über ein Design-System (`design-system`), Tailwind-Tokens + Compose-Tokens werden in alle Apps synchronisiert, nicht copy-pasted.',
  ...
  'wissens-foederation': {
    ...
    result: [
      'Sieben reale Quellen sind über eine einzige Such-API durchsuchbar, jeder Backend-Zugriff token-abgesichert.',
    ...
    decisions: [
      ...
      {
        title: 'Wissen ist nicht Betriebszustand',
        body: 'Vier der ursprünglich elf Quellen habe ich wieder ausgebaut: Inventar, Marktdaten, Termine und Post. Sie ließen sich technisch problemlos anbinden, und genau das war die Falle. Eine Wissenssuche beantwortet „was weiß ich darüber", eine Anwendung beantwortet „wie ist der Stand". Wer beides mischt, bekommt Treffer, die alt aussehen, obwohl die Anwendung längst weiter ist, und muss anfangen, Aktualität zu synchronisieren. Weniger Quellen, dafür eine klare Zuständigkeit pro Frage.',
      },
    ],
    metrics: [
      {
    ...
    timeline: [
      ...
      {
        when: '2026 H2',
        what: 'Vier Quellen wieder ausgebaut: Grenze zwischen Wissen und Betriebszustand gezogen',
      },
    ],
  },
  'offline-wissen': {
    ...
    decisions: [
      {
        ...
        body: 'Der übliche Weg für Adress-Suche über offene Kartendaten verlangt rund hundert Gigabyte Datenbank und mehr als sechzehn Gigabyte Arbeitsspeicher. Auf dem vorgesehenen Rechner sind ein paar Gigabyte frei. Statt den Anspruch zu senken steht hier ein eigener Index, zugeschnitten auf genau eine Frage: welche Straße, welche Hausnummer, welcher Ort. Das Ergebnis passt in gut ein Gigabyte, und der Bau kam mit unter 500 Megabyte Arbeitsspeicher aus, in Stufen, die sich einzeln wiederholen lassen.',
      },
      {
  ...
  concierge: {
    ...
    decisions: [
      ...
      {
        title: 'Das Modell tauschen, nicht die Hardware aufrüsten',
        body: 'Die Spracherkennung brauchte gut fünf Sekunden je Befehl, und das war der Grund, warum sich der gesprochene Weg zäh anfühlte, nicht die Antwortzeit des Sprachmodells. Naheliegend wäre stärkere Hardware gewesen. Stattdessen kam ein anderes Erkennungsmodell auf dieselbe Maschine, quantisiert und in einer schlankeren Laufzeit: aus 5,08 Sekunden wurden 0,33, gemessen über denselben Satz Testbefehle. Das alte Modell bleibt als Rückfallweg im Rezept stehen, weil es bei Störgeräuschen robuster ist. Der Unterschied zwischen fünf Sekunden und einer Drittelsekunde ist der zwischen einem Werkzeug, das man benutzt, und einem, um das man einen Bogen macht.',
      },
    ],
    metrics: [
      ...
      { label: 'Spracherkennung', value: '0,33 s je Befehl, vorher 5,08 s' },
    ],
    timeline: [
  ...
  'defense-in-depth': {
    ...
    approach: [
      ...
      'Identität zentral über einen SSO-/OIDC-Anbieter, Anmeldeschutz mit Sperrzeiten und ein Real-IP-Fix, damit hinter dem Edge die echte Client-Adresse im Log steht und nicht die des Tunnels.',
      'Angriffserkennung am Rand, ohne automatisches Sperren: Auffälligkeiten laufen über den eigenen Event-Bus als Push, gebannt wird erst nach manueller Freigabe.',
      'Verschlüsseltes Off-Site-Backup pro Host mit getrennten Repos und einem wiederkehrenden Restore-Drill, damit die Wiederherstellung erprobt ist und nicht bloß dokumentiert.',
    ],
    architecture: {
        ...
        },
        {
          ...
          nodes: [
            ...
            },
            {
              ...
              note: 'nur Erkennung, kein Auto-Bann',
              kind: 'core',
            },
            {
              id: 'bus',
          ...
          nodes: [
            {
              ...
              note: 'verschlüsselt · getrennte Repos',
              kind: 'data',
            },
            {
              id: 'drill',
  ...
  'ops-cockpit': {
    ...
    metrics: [
      ...
      {
        label: 'Fehlalarme',
        value: 'aus erwarteten Stilllegungen: beseitigt',
      },
    ],
    timeline: [
      {
  ...
  'ai-vision': {
    ...
    result: [
      'Erkennungsmodell auf eigener Edge-Hardware, eingebunden in den restlichen Eigen-Stack, Warm-Inferenz im Bruchteil einer Sekunde.',
    ...
    limits: [
      'Die Erkennung hängt an genau einem Rechner: fällt er aus, steht sie. Beim Umbau der Verkabelung war das eine Weile der Fall. Der Rest des Stacks merkt davon nichts, weil die Bild-Aufträge in der Warteschlange stehen bleiben statt zu scheitern, und genau dafür ist sie da.',
      'Die Hardware ist erste Generation: knapper Speicher, alte Toolchain. Das begrenzt die Modellgröße spürbar und macht jeden Versions-Sprung zu einem eigenen kleinen Projekt.',
    ],
  },
  rackforge: {
    problem:
      'Für einen Shop, der 3D-gedruckte Teile verkauft, passt kein Standard-Shop-System sauber: dieselbe Form gibt es in vielen Farben, vieles wird erst auf Bestellung gedruckt, und der Bestand sind nicht fertige Artikel im Regal, sondern Filament-Rollen und ein paar vorproduzierte Stücke. Ein Baukasten-Shop zwingt dieses Modell in seine Artikel-Logik, und danach kämpft man gegen die Plattform. Also steht hier ein eigener Shop ohne Baukasten: eigenes Datenmodell, eigene Kasse, eigene Bestands-Regeln, die zu Fertigung auf Bestellung passen.',
    approach: [
      ...
      'Ein eigener Upload-Pfad für hochgeladene Druckdateien mit eigenem Multipart-Parser, der erlaubte Formate und eine Größengrenze hart durchsetzt, ohne sich auf eine Fremd-Bibliothek zu verlassen.',
    ...
    decisions: [
      ...
      },
      {
        ...
        body: 'Hochgeladene Dateien sind eine Angriffsfläche. Ein eigener Multipart-Parser, der nur erlaubte Formate und eine feste Größengrenze durchlässt, hält die Kontrolle im eigenen Code.',
      },
    ],
    metrics: [
  ...
  'cms-baukasten': {
    problem:
      'Kleine Websites brauchen ein Content-Management, aber ein schwergewichtiges Fremd-CMS ist für eine simple Seite überdimensioniert: ständige Updates, große Angriffsfläche, am Ende mehr Plugin als Inhalt. Jede Seite neu aufzusetzen ist aber auch keine Lösung. Gesucht war eine eigene, schlanke Grundlage, auf der sich Inhalte bequem pflegen lassen und bei der eine neue Seite vor allem eine Konfigurations-Frage ist.',
    approach: [
  ...
  'ressourcen-arbiter': {
    ...
    approach: [
      ...
      'Fordert jemand eine Rolle an, prüft der Regler den gemessenen freien Arbeitsspeicher gegen eine je Rolle hinterlegte Untergrenze. Reicht er, startet die Rolle und keine andere muss weichen. Reicht er nicht, weicht zuerst, was leer und ungeschützt ist, und wird vorher sauber heruntergefahren.',
      ...
      'Solange die schweren Rollen zu Hause standen, lief der öffentliche Zugang ausschließlich über einen VPN-Tunnel zu einem eigenen Server am Netz-Rand: kein offener Port am Heimrouter, und für Dienste, die sich selbst bei einem öffentlichen Verzeichnis anmelden, lief sogar der gesamte ausgehende Verkehr durch diesen Tunnel, damit dort nicht die Anschluss-Adresse erscheint. Mit dem Umzug auf einen eigenen Server ist diese ganze Schicht ersatzlos entfallen.',
      'Der Regler selbst zog mit: dasselbe Programm läuft heute an zwei Orten und liest an jedem ein eigenes Profil, das sagt, welche Rollen es dort überhaupt gibt. Am einen Ort steuert er die umgezogenen Dienste, am anderen nur noch ein Windows-Lab. Zwei Wirte, ein Regler, kein zweiter Zweig im Code.',
    ...
    architecture: {
      summary:
        'Zugriffe von außen erreichen die Rollen direkt auf ihrem Wirt; der frühere Umweg über einen Tunnel entfiel mit dem Umzug. Ein Regler plant den Speicher des Wirts: er liest die Rollen aus einer Registrierdatei, fragt echte Auslastung ab und entscheidet über jeden Start am gemessenen freien Speicher. Belegte Rollen werden nie erzwungen geräumt, im Zweifel wird die Anfrage abgelehnt. Gesteuert wird über eine token-geschützte Brücke im eigenen Netz, und die Zustands-Daten gehen über einen Vor-Sicherungs-Schritt verschlüsselt an einen entfernten Ort.',
      tiers: [
        {
          label: 'Öffentlich',
          nodes: [{ id: 'user', label: 'Zugriff von außen', kind: 'edge' }],
        },
        {
          label: 'Steuerung',
          nodes: [
            { id: 'ui', label: 'Chat-Befehl · Weboberfläche', note: 'wecken · reservieren', kind: 'edge' },
        ...
        },
        {
          label: 'Wirt',
          nodes: [
            { id: 'arbiter', label: 'Regler', note: 'Registrierdatei · Auslastung · freier Speicher', kind: 'core' },
            { id: 'guests', label: 'Rollen', note: 'systemd · sauberes Speichern beim Stopp', kind: 'core' },
          ],
        },
        {
          label: 'Daten',
      ...
      flows: [
        { from: 'user', to: 'guests', label: 'direkt, ohne Umweg' },
        { from: 'ui', to: 'bridge' },
        { from: 'bridge', to: 'arbiter', label: 'wecken · reservieren' },
        { from: 'arbiter', to: 'guests', label: 'starten · abschalten, nie erzwungen' },
        { from: 'guests', to: 'state' },
        { from: 'state', to: 'offsite' },
      ],
    },
    result: [
      'Mehrere schwere Rollen teilen sich einen Knoten, ohne ihn je zu überbuchen. Über jeden Start entscheidet der gemessene freie Speicher gegen den angemeldeten Bedarf der Rolle, nicht ein fest vergebener Platz. Reicht er, weicht niemand.',
      'Wer eine Rolle gerade benutzt, verliert sie nicht. Ist es zu eng, weicht zuerst, was leer und ungeschützt ist; reicht auch das nicht, kommt eine Absage im Klartext statt eines Rauswurfs.',
      ...
      'Eine neue Rolle aufzunehmen ist ein Eintrag in einer Registrierdatei, keine Code-Änderung am Regler. Auch der zweite Wirt, der später dazukam, brauchte keine zweite Fassung des Reglers, nur ein eigenes Profil.',
      ...
      'Die halbe Konstruktion ist inzwischen ersatzlos verschwunden: Tunnel, Weiterleitungsregeln und die Sonderbehandlung für Dienste, die sich selbst öffentlich anmelden, waren nur nötig, solange die Rollen zu Hause standen.',
    ...
    decisions: [
      ...
      {
        title: 'Wer arbeitet, wird nicht verdrängt',
        body: 'Der Regler konnte eine laufende Rolle auf Anweisung räumen. Gedacht war das als Notausgang, und es war genau falsch herum: die einzige Lage, in der man ihn gebraucht hätte, ist die, in der gerade jemand mit der Rolle arbeitet. Der Weg wurde ersatzlos gestrichen, und wer ihn heute noch aufruft, bekommt eine laute Absage statt einer stillen Wirkung. Ist der Speicher knapp, weicht zuerst, was leer und ungeschützt ist, und wenn das nicht reicht, wird die Anfrage abgelehnt und begründet. Eine Absage, die man versteht, ist besser als ein Rauswurf, den niemand kommen sah.',
      },
      {
        title: 'Aus einem Platz wurde eine Menge',
        body: 'Anfangs gab es genau einen Platz, und jeder Start bedeutete, dass ein anderer gehen musste. Das war einfach zu bauen und zu streng: zwei kleine Rollen hätten oft nebeneinander gepasst. Heute führt der Regler je Rolle eigene Uhren und entscheidet über jeden Start am gemessenen freien Speicher gegen den angemeldeten Bedarf. Frisch gestartete Rollen zählen eine Weile mit ihrem angemeldeten Wert mit, weil ihr Speicher im gemessenen Wert noch gar nicht sichtbar ist.',
      },
      {
      ...
      {
        title: 'Der Umzug, der die halbe Konstruktion überflüssig machte',
        body: 'Der aufwendigste Teil dieses Systems diente nie der Planung, sondern der Tarnung: ein Tunnel zu einem Server am Netz-Rand, eine Weiterleitungsregel je Rolle, und für die Dienste, die sich selbst bei einem öffentlichen Verzeichnis anmelden, lief sogar der gesamte ausgehende Verkehr durch diesen Tunnel, damit dort nicht die Anschluss-Adresse erscheint. Als die schweren Rollen auf einen eigenen Server umzogen, fiel diese Hälfte ersatzlos weg, nicht durch eine bessere Lösung, sondern weil es nichts mehr zu verbergen gab: der Server steht selbst öffentlich. Je Rolle entfielen ein Tunnel-Ende, eine Weiterleitungsregel und eine Sonderbehandlung. Der Regler blieb, weil seine eigentliche Aufgabe davon unberührt ist. Im Rückblick war der Tunnel keine Lösung, sondern der Preis für einen Standort, der nicht passte, und den Preis erkennt man erst, wenn man ihn nicht mehr zahlt.',
      },
      {
    ...
    metrics: [
      { label: 'Schwere Rollen im Regler', value: 'sieben, dazu ein Windows-Lab' },
      { label: 'Gleichzeitig aktiv', value: 'so viele, wie der Speicher trägt' },
      { label: 'Abschaltung bei Leerlauf', value: 'nach zwanzig Minuten' },
      { label: 'Erzwungene Verdrängung', value: 'gibt es nicht' },
    ],
    timeline: [
      ...
      { when: '2026 H2', what: 'Aus einem Platz wird eine Menge: mehrere Rollen laufen nebeneinander, solange der gemessene Speicher sie trägt' },
      { when: '2026 H2', what: 'Erzwungene Verdrängung ersatzlos gestrichen; die schweren Rollen ziehen auf einen eigenen Server, Tunnel und Weiterleitungen entfallen mit ihnen' },
    ],
    limits: [
      'Der Regler tauscht Verfügbarkeit gegen Arbeitsspeicher: ein Kaltstart kostet die Wecken-Zeit, bei der schwersten Rolle mehrere Minuten. Für selten gebrauchte Rollen ist das richtig, für Dienste, die durchgehend verfügbar sein müssen, wäre es das nicht.',
      'Ohne erzwungene Verdrängung kann eine Anfrage abgelehnt werden, obwohl theoretisch Speicher zu räumen wäre, nämlich dann, wenn die belegten Rollen gerade benutzt werden. Das ist die gewollte Seite des Tauschs. Wer sicher gehen will, reserviert seine Rolle vorher, statt auf gutes Timing zu hoffen.',
