...
import { asLocale, localeAlternates, localeOpenGraph } from '@/lib/i18n/config';
...
export async function generateMetadata(
  ...
  return {
    ...
    // ★ Kein `follow: false` mehr: die Seite trägt die vollständige Fußzeilen-Navigation,
    // mit nofollow war sie eine Sackgasse im Crawl-Graphen ohne Gegenwert.
    openGraph: localeOpenGraph(locale, '/impressum', beschreibung, getAbout(locale).name),
  };
}
    ...
    <div className="relative">
      ...
      <main id="main" className="mx-auto max-w-3xl px-6 pb-32 pt-12 sm:px-8 sm:pt-16">
        ...
        <div className="mt-12 overflow-hidden rounded-lg border border-border bg-surface/40">
          ...
          {/* Der frühere Verweis auf die OS-Plattform der EU-Kommission ist entfallen:
              die Plattform wurde zum 20.07.2025 eingestellt, der Link ging ins Leere.
              Die Erklärung zur Verbraucherschlichtung bleibt zulässig und üblich. */}
