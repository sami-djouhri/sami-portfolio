 ...
 * Dienste, geholt von der Gatus-Instanz auf dem externen Aussenposten (status.djouhri.de).
 ...
 * existiert (scripts/ensure-dns.sh im Sentinel-Repo, owner-gated), leuchtet der
